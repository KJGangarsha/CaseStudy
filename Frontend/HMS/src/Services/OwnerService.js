...
/* Axios calls */
const EMPLOYEE_API_FINDALL_URL = "http://localhost:8081/owner/findManagers";
const EMPLOYEE_API_ADDMANAGER_URL = "http://localhost:8081/owner/addManager";
const EMPLOYEE_API_VIEWMANAGER_URL = "http://localhost:8081/owner/findManager";
const EMPLOYEE_API_EDITMANAGER_URL = "http://localhost:8081/owner/editManager";
const EMPLOYEE_API_DELETEMANAGER_URL =
  "http://localhost:8081/owner/deleteManager";
