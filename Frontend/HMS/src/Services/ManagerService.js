...
/* staff */
const EMPLOYEE_API_FINDALLS_URL = "http://localhost:8082/manager/findStaffs";
const EMPLOYEE_API_ADDEMPLOYEE_URL = "http://localhost:8082/manager/addStaff";
const EMPLOYEE_API_VIEWEMPLOYEE_URL = "http://localhost:8082/manager/findStaff";
const EMPLOYEE_API_EDITEMPLOYEE_URL = "http://localhost:8082/manager/editStaff";
const EMPLOYEE_API_DELETEEMPLOYEE_URL =
  "http://localhost:8082/manager/deleteStaff";

/* inventory */
const EMPLOYEE_API_FINDALLI_URL =
  "http://localhost:8082/manager/findInventories";
const EMPLOYEE_API_ADDINVENTORY_URL =
  "http://localhost:8082/manager/addInventory";
const EMPLOYEE_API_VIEWINVENTORY_URL =
  "http://localhost:8082/manager/findInventory";
const EMPLOYEE_API_EDITINVENTORY_URL =
  "http://localhost:8082/manager/editInventory";
const EMPLOYEE_API_DELETEINVENTORY_URL =
  "http://localhost:8082/manager/deleteInventory";

/* rooms */
const EMPLOYEE_API_FINDALLR_URL = "http://localhost:8082/manager/findRooms";
const EMPLOYEE_API_ADDROOM_URL = "http://localhost:8082/manager/addRoom";
const EMPLOYEE_API_FINDAVAILROOMS_URL =
  "http://localhost:8082/manager/availRooms";
const EMPLOYEE_API_VIEWROOM_URL = "http://localhost:8082/manager/findRoom";
const EMPLOYEE_API_VIEWBYROOM_URL =
  "http://localhost:8082/manager/findRoomByNumber";
const EMPLOYEE_API_EDITROOM_URL = "http://localhost:8082/manager/editRoom";
const EMPLOYEE_API_DELETEROOM_URL = "http://localhost:8082/manager/deleteRoom";
